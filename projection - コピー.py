...
def to_pj():
    # global box_cord = []
    # # 左上
    # f = open("box_leftupcord.txt", "r")
    # box_cord[0] = f.read()
    # if box_leftupcord is not None:
    #     print("左上OK")
    # f.close()
    # # 左下
    # f = open("box_leftdowncord.txt", "r")
    # box_cord[1] = f.read()
    # if box_leftdowncord is not None:
    #     print("左下OK")
    # f.close()
    # # 右下
    # f = open("box_rightdowncord.txt", "r")
    # box_cord[2] = f.read()
    # if box_rightdowncord is not None:
    #     print("右下OK")
    # f.close()
    # # 右上
    # f = open("box_rightupcord.txt", "r")
    # box_cord[3] = f.read()
    # if box_rightupcord is not None:
    #     print("右上OK")
    # f.close()
    ...
    global pj_cord
    pj_cord = []
    # f = open("bb_cord.txt","r")
    # bb_cord = f.read()
    # f.close()
    bb_cord = np.loadtxt("bb_cord.txt", np.int32)
    if bb_cord is not None:
        print("bb_cord読み込みOK")
        print(bb_cord)
        # print("bb_cord:{}".fotmat(bb_cord))
    
    # カメラからプロジェクタへの射影変換行列
    homography_cmpj = np.loadtxt("homography_pjcm.txt", np.int32)
    ...
    for i in range(4):
        ...
        # print(bb_cord_array)
        pj_cord.append(np.dot(homography_cmpj, bb_cord_array))
        print("座標", pj_cord[i])
    ...
    # PJ視点から3次元座標へ変換
    projection_matrix = np.loadtxt("projection_matrix.txt", np.int32)
    modelview_matrix = np.loadtxt("modelview_matrix.txt", np.int32)
    homo = np.dot(modelview_matrix,pj_cord)
    print(homo)
...
def calc_straight():
    ...
    # # pj視点の左上
    # f = open("pj_leftupccord.txt","r")
    # pj_cord[0] = f.read()
    # f.close()
    # # pj視点の左下
    # f = open("pj_leftudowncord.txt","r")
    # pj_cord[1] = f.read()
    # f.close()
    # # pj視点の右下
    # f = open("pj_rightdowncord.txt","r")
    # pj_cord[2] = f.read()
    # f.close()
    # # pj視点の右上
    # f = open("pj_rightupcord.txt","r")
    # pj_cord[3] = f.read()
    # f.close()
