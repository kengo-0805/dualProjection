...
# マーカーのサイズ
marker_length = 0.052 # [m]

# camera_matrix = np.load("mtx.npy")
# print(type(camera_matrix))
camera_matrix =  np.array([[619.15713149   ,0.0    ,     315.5496068 ],[  0.0         ,615.74240951 ,255.77433656] ,[  0.0           ,0.0           ,1.0        ]])
'''np.array(([956.78928232,   0.,     11    645.67414608,],
                        [  0.,         955.45250146, 367.70419916,],
                        [  0.,           0.,           1.        ]))'''
distortion_coeff = np.load("dist.npy") #np.array(([0,0,0,0,0]))
distortion_coeff = np.array([ 0.01449953  ,0.52749336  ,0.01235545 ,-0.00676105 ,-1.97156104])
